...
void PrlVmDefaultConfigTest::testSetDefaultConfigCheckDefaultRamSizeForLinOses()
{
	...
	TEST_DEFAULT_RAM_SIZE(PVS_GUEST_VER_LIN_REDHAT_8, 2048, 2048, 3073, 32, 32)
	TEST_DEFAULT_RAM_SIZE(PVS_GUEST_VER_LIN_REDHAT_8, 2048, 2048, 2049, 32, 32)
	TEST_DEFAULT_RAM_SIZE(PVS_GUEST_VER_LIN_REDHAT_8, 2048, 2048, 2048, 32, 32)
	...
	TEST_DEFAULT_RAM_SIZE(PVS_GUEST_VER_LIN_CENTOS_8, 2048, 2048, 3073, 32, 32)
	TEST_DEFAULT_RAM_SIZE(PVS_GUEST_VER_LIN_CENTOS_8, 2048, 2048, 2049, 32, 32)
	TEST_DEFAULT_RAM_SIZE(PVS_GUEST_VER_LIN_CENTOS_8, 2048, 2048, 2048, 32, 32)
...
void PrlVmDefaultConfigTest::testSetDefaultConfigCheckDefaultHddSizeForLinOses()
{
	...
	TEST_DEFAULT_HDD_SIZE(PVS_GUEST_VER_LIN_REDHAT_8, 65536, 65536)
	...
	TEST_DEFAULT_HDD_SIZE(PVS_GUEST_VER_LIN_CENTOS_8, 65536, 65536)
