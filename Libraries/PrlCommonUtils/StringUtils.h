...
/**
* Convert CFString to QString. Based on MicroAppUtils from ver.3
*
* @author alexz
* @see CMacHIToolbar.cpp::g_QStringFromCFString()
*
* @param cf_string - string to be converted
*
* @return reference to converted string
*/
extern QString g_QStringFromCFString( const CFStringRef cf_string );
/**
* Convert QString to CFString.
*
* @author antonz
*
...
* @return reference to converted string
*/
extern CFStringRef g_CFStringFromQString( const QString& q_string );
