...
{
	typedef Ordered<mpl::vector<Attribute<Blocksnapshot::Xml::VName, Name::Strict<107> >, Optional<Attribute<mpl::int_<500>, Name::Strict<105> > >, Element<Attribute<Blocksnapshot::Xml::PAbsFilePath, Name::Strict<500> >, Name::Strict<2331> > > > marshal_type;
