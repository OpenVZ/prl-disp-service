...
bool Traits<Network::Xml::PData1124>::parse(const QString& src_, Network::Xml::PData1124::value_type& dst_)
{
	bool output = false;
...
QString Traits<Network::Xml::PData1124>::generate(Network::Xml::PData1124::value_type src_)
{
	return QString::number(src_);
}

bool Validatable<Network::Xml::PData1124>::validate(Network::Xml::PData1124::value_type value_)
{
	if (0 > value_)
		return false;
...
QString Traits<Network::Xml::VUUID>::generate(const Network::Xml::VUUID& src_)
{
	...
	{
	case 0:
		return Marshal<Network::Xml::PData1130>::getString(boost::get<mpl::at_c<Network::Xml::VUUID::types, 0>::type>(src_));
	case 1:
		return Marshal<Network::Xml::PData1132>::getString(boost::get<mpl::at_c<Network::Xml::VUUID::types, 1>::type>(src_));
	}
	return QString();
}
...
QString Traits<Network::Xml::VUint8range>::generate(const Network::Xml::VUint8range& src_)
{
	...
	{
	case 0:
		return Marshal<Network::Xml::PData1122>::getString(boost::get<mpl::at_c<Network::Xml::VUint8range::types, 0>::type>(src_));
	case 1:
		return Marshal<Network::Xml::PData1124>::getString(boost::get<mpl::at_c<Network::Xml::VUint8range::types, 1>::type>(src_));
	}
	return QString();
}
...
QString Traits<Network::Xml::VUint24range>::generate(const Network::Xml::VUint24range& src_)
{
	...
	{
	case 0:
		return Marshal<Network::Xml::PData1126>::getString(boost::get<mpl::at_c<Network::Xml::VUint24range::types, 0>::type>(src_));
	case 1:
		return Marshal<Network::Xml::PData1128>::getString(boost::get<mpl::at_c<Network::Xml::VUint24range::types, 1>::type>(src_));
	}
	return QString();
}
