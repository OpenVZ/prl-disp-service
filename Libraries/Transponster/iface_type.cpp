...
int Traits<Iface::Xml::Variant1291>::parse(Iface::Xml::Variant1291& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Iface::Xml::Variant1291>::generate(const Iface::Xml::Variant1291& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Iface::Xml::InterfaceAddressing1286>::parse(Iface::Xml::InterfaceAddressing1286& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Iface::Xml::InterfaceAddressing1286>::generate(const Iface::Xml::InterfaceAddressing1286& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Iface::Xml::InterfaceAddressing1287>::parse(Iface::Xml::InterfaceAddressing1287& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Iface::Xml::InterfaceAddressing1287>::generate(const Iface::Xml::InterfaceAddressing1287& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getProtocol(), m.get<0>()))
		return -1;
...
bool BasicEthernetContent::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<BasicEthernetContent, Name::Strict<623> > m;
	if (0 > m.consume(k))
		return false;
...
bool Vlan::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Vlan, Name::Strict<194> > m;
	if (0 > m.consume(k))
		return false;
...
bool Interface1::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Interface1, Name::Strict<623> > m;
	if (0 > m.consume(k))
		return false;
...
bool Miimon::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Miimon, Name::Strict<1268> > m;
	if (0 > m.consume(k))
		return false;
...
bool Arpmon::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Arpmon, Name::Strict<1276> > m;
	if (0 > m.consume(k))
		return false;
...
bool Bond::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Bond, Name::Strict<1259> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Iface::Xml::Bond>::parse(Iface::Xml::Bond& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setChoice1281(m.get<1>().get<0>().getValue());
...
int Traits<Iface::Xml::Bond>::generate(const Iface::Xml::Bond& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getMode(), m.get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice1281(), m.get<1>().get<0>()))
		return -1;
...
bool Interface2::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Interface2, Name::Strict<623> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Iface::Xml::Bridge>::parse(Iface::Xml::Bridge& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setChoice1256List(m.get<2>().getValue());
	}
	return output;
}
...
int Traits<Iface::Xml::Bridge>::generate(const Iface::Xml::Bridge& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getDelay(), m.get<1>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice1256List(), m.get<2>()))
		return -1;
...
bool Interface3::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Interface3, Name::Strict<623> > m;
	if (0 > m.consume(k))
		return false;
...
bool Interface4::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Interface4, Name::Strict<623> > m;
	if (0 > m.consume(k))
		return false;
