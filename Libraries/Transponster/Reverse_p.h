...
struct List;
typedef QList<Libvirt::Domain::Xml::VChoice977 > deviceList_type;
...
struct Factory
{
	typedef Libvirt::Domain::Xml::VChoice977 result_type;
...
struct Arrangement
{
	typedef boost::function<Libvirt::Domain::Xml::VChoice977 (quint16)>
		factory_type;
