...
struct List;
typedef QList<Libvirt::Domain::Xml::VChoice978 > deviceList_type;
...
struct Factory
{
	typedef Libvirt::Domain::Xml::VChoice978 result_type;
...
struct Arrangement
{
	typedef boost::function<Libvirt::Domain::Xml::VChoice978 (quint16)>
		factory_type;
