...
struct List;
typedef QList<Libvirt::Domain::Xml::VChoice979 > deviceList_type;
...
struct Factory
{
	typedef Libvirt::Domain::Xml::VChoice979 result_type;
...
struct Arrangement
{
	typedef boost::function<Libvirt::Domain::Xml::VChoice979 (quint16)>
		factory_type;
