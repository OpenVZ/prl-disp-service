...
struct Cpu1
{
	...
	const boost::optional<Anonymous1807 >& getAnonymous1807() const
	{
		return m_anonymous1807;
	}
	void setAnonymous1807(const boost::optional<Anonymous1807 >& value_)
	{
		m_anonymous1807 = value_;
	}
	bool load(const QDomElement& );
	bool save(QDomElement& ) const;
	bool save(QDomDocument& ) const;
...
private:
	PUnsignedInt::value_type m_id;
	boost::optional<Anonymous1807 > m_anonymous1807;
};
...
{
	typedef Ordered<mpl::vector<Optional<Element<Empty, Name::Strict<941> > >, Optional<Element<Empty, Name::Strict<1774> > >, Optional<Element<Empty, Name::Strict<1775> > >, Optional<Element<Empty, Name::Strict<1776> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PPositiveInteger, Name::Strict<977> >, Attribute<Capability::Xml::PPositiveInteger, Name::Strict<978> >, Attribute<Capability::Xml::PPositiveInteger, Name::Strict<551> > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Optional<Attribute<Capability::Xml::PUnit, Name::Strict<60> > >, Attribute<Capability::Xml::PUnsignedInt, Name::Strict<319> >, Text<Capability::Xml::PUnsignedInt > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Element<Text<QString >, Name::Strict<216> >, Optional<Element<Text<QString >, Name::Strict<441> > >, Element<Capability::Xml::Topology, Name::Strict<976> >, ZeroOrMore<Element<Attribute<Capability::Xml::PFeatureName, Name::Strict<101> >, Name::Strict<970> > >, ZeroOrMore<Element<Capability::Xml::Pages, Name::Strict<1807> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Element<Text<Capability::Xml::EArchnames >, Name::Strict<270> >, Optional<Element<Capability::Xml::Features, Name::Strict<143> > >, Optional<Fragment<Capability::Xml::Cpuspec > > > > marshal_type;
...
{
	typedef Unordered<mpl::vector<Optional<Element<Empty, Name::Strict<1778> > >, Optional<Element<Empty, Name::Strict<1779> > >, Optional<Element<Empty, Name::Strict<1780> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Optional<Element<Empty, Name::Strict<1782> > >, Optional<Element<OneOrMore<Element<Text<Capability::Xml::EUriTransport >, Name::Strict<1784> > >, Name::Strict<1783> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Optional<Attribute<Capability::Xml::PUnit, Name::Strict<60> > >, Text<Capability::Xml::PUnsignedLong > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<196> >, Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1032> > > > marshal_type;
...
///////////////////////////////////////////////////////////////////////////////
// struct Anonymous1807 traits

template<>
struct Traits<Capability::Xml::Anonymous1807>
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1791> >, Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1792> >, Attribute<Capability::Xml::PCpuset, Name::Strict<1793> > > > marshal_type;

	static int parse(Capability::Xml::Anonymous1807& , QStack<QDomElement>& );
	static int generate(const Capability::Xml::Anonymous1807& , QDomElement& );
};
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<196> >, Optional<Fragment<Capability::Xml::Anonymous1807 > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1788> >, OneOrMore<Element<Capability::Xml::Cpu1, Name::Strict<205> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<196> >, Optional<Element<Capability::Xml::ScaledInteger, Name::Strict<311> > >, ZeroOrMore<Element<Capability::Xml::Pages, Name::Strict<1807> > >, Optional<Element<ZeroOrMore<Element<Capability::Xml::Sibling, Name::Strict<1790> > >, Name::Strict<1789> > >, Optional<Element<Capability::Xml::Cpus, Name::Strict<982> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1788> >, OneOrMore<Element<Capability::Xml::Cell, Name::Strict<981> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<QString, Name::Strict<99> >, Text<QString > > > marshal_type;
...
{
	typedef Unordered<mpl::vector<Element<Text<QString >, Name::Strict<216> >, Element<Text<QString >, Name::Strict<1773> >, ZeroOrMore<Element<Capability::Xml::Baselabel, Name::Strict<221> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Optional<Element<Text<Capability::Xml::VUUID >, Name::Strict<139> > >, Element<Capability::Xml::Cpu, Name::Strict<205> >, Optional<Element<Capability::Xml::PowerManagement, Name::Strict<1770> > >, Optional<Element<Capability::Xml::MigrationFeatures, Name::Strict<1781> > >, Optional<Element<Element<Capability::Xml::Cells, Name::Strict<1787> >, Name::Strict<976> > >, ZeroOrMore<Element<Capability::Xml::Secmodel, Name::Strict<1772> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Optional<Attribute<QString, Name::Strict<1800> > >, Optional<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1801> > >, Text<QString > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::EType, Name::Strict<99> >, Optional<Element<Text<Capability::Xml::PAbsFilePath >, Name::Strict<672> > >, ZeroOrMore<Element<Capability::Xml::Machine, Name::Strict<271> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::EArchnames, Name::Strict<101> >, Element<Text<Capability::Xml::EWordsize >, Name::Strict<1796> >, Optional<Element<Text<Capability::Xml::PAbsFilePath >, Name::Strict<672> > >, Optional<Element<Text<Capability::Xml::PAbsFilePath >, Name::Strict<258> > >, ZeroOrMore<Element<Capability::Xml::Machine, Name::Strict<271> > >, OneOrMore<Element<Capability::Xml::Domain, Name::Strict<1> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::EVirYesNo, Name::Strict<1806> >, Attribute<Capability::Xml::EVirOnOff, Name::Strict<135> > > > marshal_type;
...
{
	typedef Unordered<mpl::vector<Optional<Element<Empty, Name::Strict<941> > >, Optional<Element<Empty, Name::Strict<1774> > >, Optional<Element<Empty, Name::Strict<1802> > >, Optional<Element<Capability::Xml::Featuretoggle, Name::Strict<944> > >, Optional<Element<Capability::Xml::Featuretoggle, Name::Strict<942> > >, Optional<Element<Empty, Name::Strict<1804> > >, Optional<Element<Empty, Name::Strict<1805> > >, Optional<Element<Capability::Xml::Featuretoggle, Name::Strict<1504> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Element<Text<Capability::Xml::EOsType >, Name::Strict<1795> >, Element<Capability::Xml::Arch, Name::Strict<270> >, Optional<Element<Capability::Xml::Features1, Name::Strict<143> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Element<Capability::Xml::Host, Name::Strict<494> >, ZeroOrMore<Element<Capability::Xml::Guest, Name::Strict<389> > > > > marshal_type;
