...
struct Cpu1
{
	...
	const boost::optional<Anonymous1813 >& getAnonymous1813() const
	{
		return m_anonymous1813;
	}
	void setAnonymous1813(const boost::optional<Anonymous1813 >& value_)
	{
		m_anonymous1813 = value_;
	}
	bool load(const QDomElement& );
	bool save(QDomElement& ) const;
	bool save(QDomDocument& ) const;
...
private:
	PUnsignedInt::value_type m_id;
	boost::optional<Anonymous1813 > m_anonymous1813;
};
...
{
	typedef Ordered<mpl::vector<Optional<Element<Empty, Name::Strict<944> > >, Optional<Element<Empty, Name::Strict<1780> > >, Optional<Element<Empty, Name::Strict<1781> > >, Optional<Element<Empty, Name::Strict<1782> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PPositiveInteger, Name::Strict<980> >, Attribute<Capability::Xml::PPositiveInteger, Name::Strict<981> >, Attribute<Capability::Xml::PPositiveInteger, Name::Strict<552> > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Element<Text<QString >, Name::Strict<217> >, Optional<Element<Text<QString >, Name::Strict<442> > >, Element<Capability::Xml::Topology, Name::Strict<979> >, ZeroOrMore<Element<Attribute<Capability::Xml::PFeatureName, Name::Strict<102> >, Name::Strict<973> > >, ZeroOrMore<Element<Capability::Xml::Pages, Name::Strict<1813> > > > > marshal_type;
...
{
	typedef Unordered<mpl::vector<Optional<Element<Empty, Name::Strict<1784> > >, Optional<Element<Empty, Name::Strict<1785> > >, Optional<Element<Empty, Name::Strict<1786> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Optional<Element<Empty, Name::Strict<1788> > >, Optional<Element<OneOrMore<Element<Text<Capability::Xml::EUriTransport >, Name::Strict<1790> > >, Name::Strict<1789> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<197> >, Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1036> > > > marshal_type;
...
///////////////////////////////////////////////////////////////////////////////
// struct Anonymous1813 traits

template<>
struct Traits<Capability::Xml::Anonymous1813>
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1797> >, Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1798> >, Attribute<Capability::Xml::PCpuset, Name::Strict<1799> > > > marshal_type;

	static int parse(Capability::Xml::Anonymous1813& , QStack<QDomElement>& );
	static int generate(const Capability::Xml::Anonymous1813& , QDomElement& );
};
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<197> >, Optional<Fragment<Capability::Xml::Anonymous1813 > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1794> >, OneOrMore<Element<Capability::Xml::Cpu1, Name::Strict<206> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<197> >, Optional<Element<Capability::Xml::ScaledInteger, Name::Strict<312> > >, ZeroOrMore<Element<Capability::Xml::Pages, Name::Strict<1813> > >, Optional<Element<ZeroOrMore<Element<Capability::Xml::Sibling, Name::Strict<1796> > >, Name::Strict<1795> > >, Optional<Element<Capability::Xml::Cpus, Name::Strict<985> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1794> >, OneOrMore<Element<Capability::Xml::Cell, Name::Strict<984> > > > > marshal_type;
...
{
	typedef Unordered<mpl::vector<Element<Text<QString >, Name::Strict<217> >, Element<Text<QString >, Name::Strict<1779> >, ZeroOrMore<Element<Capability::Xml::Baselabel, Name::Strict<222> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Optional<Element<Text<Capability::Xml::VUUID >, Name::Strict<140> > >, Element<Capability::Xml::Cpu, Name::Strict<206> >, Optional<Element<Capability::Xml::PowerManagement, Name::Strict<1776> > >, Optional<Element<Capability::Xml::MigrationFeatures, Name::Strict<1787> > >, Optional<Element<Element<Capability::Xml::Cells, Name::Strict<1793> >, Name::Strict<979> > >, ZeroOrMore<Element<Capability::Xml::Secmodel, Name::Strict<1778> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Optional<Attribute<QString, Name::Strict<1806> > >, Optional<Attribute<Capability::Xml::PUnsignedInt, Name::Strict<1807> > >, Text<QString > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::EType, Name::Strict<100> >, Optional<Element<Text<Capability::Xml::PAbsFilePath >, Name::Strict<673> > >, ZeroOrMore<Element<Capability::Xml::Machine, Name::Strict<272> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Attribute<Capability::Xml::EVirYesNo, Name::Strict<1812> >, Attribute<Capability::Xml::EVirOnOff, Name::Strict<136> > > > marshal_type;
...
{
	typedef Unordered<mpl::vector<Optional<Element<Empty, Name::Strict<944> > >, Optional<Element<Empty, Name::Strict<1780> > >, Optional<Element<Empty, Name::Strict<1808> > >, Optional<Element<Capability::Xml::Featuretoggle, Name::Strict<947> > >, Optional<Element<Capability::Xml::Featuretoggle, Name::Strict<945> > >, Optional<Element<Empty, Name::Strict<1810> > >, Optional<Element<Empty, Name::Strict<1811> > >, Optional<Element<Capability::Xml::Featuretoggle, Name::Strict<1509> > > > > marshal_type;
...
{
	typedef Ordered<mpl::vector<Element<Text<Capability::Xml::EOsType >, Name::Strict<1801> >, Element<Capability::Xml::Arch, Name::Strict<271> >, Optional<Element<Capability::Xml::Features1, Name::Strict<144> > > > > marshal_type;
