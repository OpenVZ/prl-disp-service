...
int Traits<Snapshot::Xml::Disk1750>::parse(Snapshot::Xml::Disk1750& , QStack<QDomElement>& stack_)
{
	marshal_type m;
	return m.consume(stack_);
}

int Traits<Snapshot::Xml::Disk1750>::generate(const Snapshot::Xml::Disk1750& , QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Snapshot::Xml::Disk1751>::parse(Snapshot::Xml::Disk1751& , QStack<QDomElement>& stack_)
{
	marshal_type m;
	return m.consume(stack_);
}

int Traits<Snapshot::Xml::Disk1751>::generate(const Snapshot::Xml::Disk1751& , QDomElement& dst_)
{
	marshal_type m;
	return m.produce(dst_);
}
...
int Traits<Snapshot::Xml::Variant1745>::parse(Snapshot::Xml::Variant1745& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Snapshot::Xml::Variant1745>::generate(const Snapshot::Xml::Variant1745& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Snapshot::Xml::Variant1746>::parse(Snapshot::Xml::Variant1746& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Snapshot::Xml::Variant1746>::generate(const Snapshot::Xml::Variant1746& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getSource(), m.get<1>().get<0>()))
		return -1;
...
int Traits<Snapshot::Xml::Host1591>::parse(Snapshot::Xml::Host1591& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Snapshot::Xml::Host1591>::generate(const Snapshot::Xml::Host1591& src_, QDomElement& dst_)
{
	marshal_type m;
...
bool Domainsnapshot::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Domainsnapshot, Name::Strict<1294> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Snapshot::Xml::Domainsnapshot>::parse(Snapshot::Xml::Domainsnapshot& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setChoice1732(m.get<7>().getValue());
...
int Traits<Snapshot::Xml::Domainsnapshot>::generate(const Snapshot::Xml::Domainsnapshot& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getActive(), m.get<6>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice1732(), m.get<7>()))
		return -1;
