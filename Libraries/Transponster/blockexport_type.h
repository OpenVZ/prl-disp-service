...
namespace Xml
{
typedef Choice<mpl::vector<Attribute<QString, Name::Strict<1180> >, Attribute<Blockexport::Xml::EVirYesNo, Name::Strict<1182> > > > VChoice8681Impl;
...
struct Disk
{
	...
	const boost::optional<VChoice8681 >& getChoice8681() const
	{
		return m_choice8681;
	}
	void setChoice8681(const boost::optional<VChoice8681 >& value_)
	{
		m_choice8681 = value_;
	}
...
private:
	...
	boost::optional<VChoice8681 > m_choice8681;
...
{
	typedef Ordered<mpl::vector<Attribute<Blockexport::Xml::VName, Name::Strict<107> >, Optional<Attribute<QString, Name::Strict<1179> > >, Optional<Attribute<QString, Name::Strict<462> > >, Optional<Blockexport::Xml::VChoice8681Impl >, Optional<Attribute<Blockexport::Xml::EVirYesNo, Name::Strict<274> > > > > marshal_type;
