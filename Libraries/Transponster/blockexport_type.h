...
namespace Xml
{
typedef Choice<mpl::vector<Attribute<QString, Name::Strict<1180> >, Attribute<Blockexport::Xml::EVirYesNo, Name::Strict<1182> > > > VChoice8127Impl;
typedef VChoice8127Impl::value_type VChoice8127;
...
struct Disk
{
	...
	const boost::optional<VChoice8127 >& getChoice8127() const
	{
		return m_choice8127;
	}
	void setChoice8127(const boost::optional<VChoice8127 >& value_)
	{
		m_choice8127 = value_;
	}
...
private:
	...
	boost::optional<VChoice8127 > m_choice8127;
...
{
	typedef Ordered<mpl::vector<Attribute<Blockexport::Xml::VName, Name::Strict<107> >, Optional<Attribute<QString, Name::Strict<1179> > >, Optional<Attribute<QString, Name::Strict<462> > >, Optional<Blockexport::Xml::VChoice8127Impl >, Optional<Attribute<Blockexport::Xml::EVirYesNo, Name::Strict<274> > > > > marshal_type;
