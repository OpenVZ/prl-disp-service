...
{
	typedef Ordered<mpl::vector<Attribute<Blockexport::Xml::VName, Name::Strict<107> >, Optional<Attribute<QString, Name::Strict<1170> > >, Optional<Attribute<QString, Name::Strict<462> > >, Optional<Attribute<QString, Name::Strict<1171> > >, Optional<Attribute<Blockexport::Xml::EVirYesNo, Name::Strict<274> > > > > marshal_type;
