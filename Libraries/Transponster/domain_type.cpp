...
namespace Xml
{
Maxphysaddr::Maxphysaddr(): m_mode()
{
}

bool Maxphysaddr::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Maxphysaddr, Name::Strict<9860> > m;
	if (0 > m.consume(k))
		return false;
...
bool Maxphysaddr::save(QDomElement& dst_) const
{
	Element<Maxphysaddr, Name::Strict<9860> > m;
	m.setValue(*this);
	return 0 <= m.produce(dst_);
...
bool Maxphysaddr::save(QDomDocument& dst_) const
{
	Element<Maxphysaddr, Name::Strict<9860> > m;
	m.setValue(*this);
	return 0 <= m.produce(dst_);
...
int Traits<Domain::Xml::Maxphysaddr>::parse(Domain::Xml::Maxphysaddr& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
	{
		...
		dst_.setBits(m.get<1>().getValue());
		dst_.setLimit(m.get<2>().getValue());
	}
	return output;
}

int Traits<Domain::Xml::Maxphysaddr>::generate(const Domain::Xml::Maxphysaddr& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getMode(), m.get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getBits(), m.get<1>()))
		return -1;
...
int Traits<Domain::Xml::Cpu>::parse(Domain::Xml::Cpu& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setMaxphysaddr(m.get<4>().get<6>().getValue());
	}
	return output;
}
...
int Traits<Domain::Xml::Cpu>::generate(const Domain::Xml::Cpu& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getCache(), m.get<4>().get<5>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getMaxphysaddr(), m.get<4>().get<6>()))
		return -1;
...
int Traits<Domain::Xml::Os>::parse(Domain::Xml::Os& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setKernel(m.get<1>().getValue());
		dst_.setInitrd(m.get<2>().getValue());
		dst_.setRoot(m.get<3>().getValue());
		dst_.setCmdline(m.get<4>().getValue());
		dst_.setDtb(m.get<5>().getValue());
	}
	return output;
}
...
int Traits<Domain::Xml::Os>::generate(const Domain::Xml::Os& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getType(), m.get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getKernel(), m.get<1>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getInitrd(), m.get<2>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getRoot(), m.get<3>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getCmdline(), m.get<4>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getDtb(), m.get<5>()))
		return -1;
...
int Traits<Domain::Xml::Osxen6979>::parse(Domain::Xml::Osxen6979& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		dst_.setBootloader(m.get<0>().get<0>().getValue());
		dst_.setOs(m.get<0>().get<1>().getValue());
	}
	return output;
}
...
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getBootloader(), m.get<0>().get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getOs(), m.get<0>().get<1>()))
		return -1;
...
int Traits<Domain::Xml::Osxen6980>::parse(Domain::Xml::Osxen6980& dst_, QStack<QDomElement>& stack_)
{
	...
	{
		dst_.setBootloader(m.get<0>().get<0>().getValue());
		dst_.setBootloaderArgs(m.get<0>().get<1>().getValue());
		dst_.setOs(m.get<0>().get<2>().getValue());
	}
	return output;
}
...
int Traits<Domain::Xml::Osxen6980>::generate(const Domain::Xml::Osxen6980& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getBootloader(), m.get<0>().get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getBootloaderArgs(), m.get<0>().get<1>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getOs(), m.get<0>().get<2>()))
		return -1;
...
namespace Xml
{
Feature1::Feature1(): m_enabled(), m_name()
{
}

bool Feature1::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Feature1, Name::Strict<1022> > m;
	if (0 > m.consume(k))
		return false;
...
bool Feature1::save(QDomElement& dst_) const
{
	Element<Feature1, Name::Strict<1022> > m;
	m.setValue(*this);
	return 0 <= m.produce(dst_);
...
bool Feature1::save(QDomDocument& dst_) const
{
	Element<Feature1, Name::Strict<1022> > m;
	m.setValue(*this);
	return 0 <= m.produce(dst_);
...
int Traits<Domain::Xml::Feature1>::parse(Domain::Xml::Feature1& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Feature1>::generate(const Domain::Xml::Feature1& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Loader>::parse(Domain::Xml::Loader& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setType(m.get<2>().getValue());
		dst_.setStateless(m.get<3>().getValue());
		dst_.setFormat(m.get<4>().getValue());
		dst_.setOwnValue(m.get<5>().getValue());
	}
	return output;
}
...
int Traits<Domain::Xml::Loader>::generate(const Domain::Xml::Loader& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getType(), m.get<2>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getStateless(), m.get<3>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getFormat(), m.get<4>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getOwnValue(), m.get<5>()))
		return -1;
...
int Traits<Domain::Xml::Variant5113>::parse(Domain::Xml::Variant5113& , QStack<QDomElement>& stack_)
{
	marshal_type m;
	return m.consume(stack_);
}

int Traits<Domain::Xml::Variant5113>::generate(const Domain::Xml::Variant5113& , QDomElement& dst_)
{
	marshal_type m;
	return m.produce(dst_);
}
...
int Traits<Domain::Xml::DiskSourceSlice>::parse(Domain::Xml::DiskSourceSlice& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::DiskSourceSlice>::generate(const Domain::Xml::DiskSourceSlice& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::DiskSourceCommon>::parse(Domain::Xml::DiskSourceCommon& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::DiskSourceCommon>::generate(const Domain::Xml::DiskSourceCommon& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Source5>::parse(Domain::Xml::Source5& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		dst_.setNamespace(m.get<1>().getValue());
		dst_.setManaged(m.get<2>().getValue());
		dst_.setAddress(m.get<3>().getValue());
		dst_.setDiskSourceCommon(m.get<4>().getValue());
		dst_.setStartupPolicy(m.get<5>().getValue());
		dst_.setEncryption(m.get<6>().getValue());
	}
	return output;
}
...
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getNamespace(), m.get<1>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getManaged(), m.get<2>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getAddress(), m.get<3>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getDiskSourceCommon(), m.get<4>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getStartupPolicy(), m.get<5>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getEncryption(), m.get<6>()))
		return -1;
...
namespace Xml
{
Reconnect::Reconnect(): m_enabled()
{
}

bool Reconnect::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Reconnect, Name::Strict<5756> > m;
	if (0 > m.consume(k))
		return false;
...
bool Reconnect::save(QDomElement& dst_) const
{
	Element<Reconnect, Name::Strict<5756> > m;
	m.setValue(*this);
	return 0 <= m.produce(dst_);
...
bool Reconnect::save(QDomDocument& dst_) const
{
	Element<Reconnect, Name::Strict<5756> > m;
	m.setValue(*this);
	return 0 <= m.produce(dst_);
...
int Traits<Domain::Xml::Reconnect>::parse(Domain::Xml::Reconnect& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Reconnect>::generate(const Domain::Xml::Reconnect& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getEnabled(), m.get<0>()))
		return -1;
...
int Traits<Domain::Xml::Source6>::parse(Domain::Xml::Source6& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setReconnect(m.get<2>().getValue());
	}
	return output;
}
...
int Traits<Domain::Xml::Source6>::generate(const Domain::Xml::Source6& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getPath(), m.get<1>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getReconnect(), m.get<2>()))
		return -1;
...
int Traits<Domain::Xml::Os2>::parse(Domain::Xml::Os2& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		dst_.setFirmware(m.get<0>().getValue());
		dst_.setType(m.get<1>().getValue());
		dst_.setFirmware2(m.get<2>().getValue());
		dst_.setLoader(m.get<3>().getValue());
		dst_.setNvram(m.get<4>().getValue());
		dst_.setOsbootkernel(m.get<5>().getValue());
		dst_.setBootList(m.get<6>().getValue());
		dst_.setBootmenu(m.get<7>().getValue());
		dst_.setSmbios(m.get<8>().getValue());
		dst_.setBios(m.get<9>().getValue());
		dst_.setAcpi(m.get<10>().getValue());
	}
	return output;
}
...
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getFirmware(), m.get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getType(), m.get<1>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getFirmware2(), m.get<2>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getLoader(), m.get<3>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getNvram(), m.get<4>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getOsbootkernel(), m.get<5>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getBootList(), m.get<6>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getBootmenu(), m.get<7>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getSmbios(), m.get<8>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getBios(), m.get<9>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getAcpi(), m.get<10>()))
		return -1;
...
int Traits<Domain::Xml::Oshvm>::parse(Domain::Xml::Oshvm& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Oshvm>::generate(const Domain::Xml::Oshvm& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getBootloader(), m.get<0>()))
		return -1;
...
int Traits<Domain::Xml::Cachetune>::parse(Domain::Xml::Cachetune& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setChoice5120List(m.get<2>().getValue());
	}
	return output;
}
...
int Traits<Domain::Xml::Cachetune>::generate(const Domain::Xml::Cachetune& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getId(), m.get<1>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice5120List(), m.get<2>()))
		return -1;
...
int Traits<Domain::Xml::Memorytune>::parse(Domain::Xml::Memorytune& dst_, QStack<QDomElement>& stack_)
{
	...
	{
		dst_.setVcpus(m.get<0>().getValue());
		dst_.setChoice5123List(m.get<1>().getValue());
	}
	return output;
}
...
int Traits<Domain::Xml::Memorytune>::generate(const Domain::Xml::Memorytune& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getVcpus(), m.get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice5123List(), m.get<1>()))
		return -1;
...
int Traits<Domain::Xml::Controller>::parse(Domain::Xml::Controller& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setChoice5126(m.get<1>().get<3>().getValue());
...
int Traits<Domain::Xml::Controller>::generate(const Domain::Xml::Controller& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getAddress(), m.get<1>().get<2>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice5126(), m.get<1>().get<3>()))
		return -1;
...
int Traits<Domain::Xml::Graphics7039>::parse(Domain::Xml::Graphics7039& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		dst_.setChoice8004(m.get<1>().getValue());
...
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getChoice8004(), m.get<1>()))
		return -1;
...
namespace Xml
{
bool Source17::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source17, Name::Strict<501> > m;
	if (0 > m.consume(k))
		return false;
...
bool Source17::save(QDomElement& dst_) const
{
	Element<Source17, Name::Strict<501> > m;
	m.setValue(*this);
	return 0 <= m.produce(dst_);
...
bool Source17::save(QDomDocument& dst_) const
{
	Element<Source17, Name::Strict<501> > m;
	m.setValue(*this);
	return 0 <= m.produce(dst_);
...
int Traits<Domain::Xml::Source17>::parse(Domain::Xml::Source17& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Source17>::generate(const Domain::Xml::Source17& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getMode(), m.get<0>()))
		return -1;
...
int Traits<Domain::Xml::Target4>::parse(Domain::Xml::Target4& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		dst_.setChoice9597(m.get<0>().getValue());
		dst_.setPort(m.get<1>().getValue());
...
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getChoice9597(), m.get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getPort(), m.get<1>()))
		return -1;
...
namespace Xml
{
bool Source18::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source18, Name::Strict<501> > m;
	if (0 > m.consume(k))
		return false;
...
bool Source18::save(QDomElement& dst_) const
{
	Element<Source18, Name::Strict<501> > m;
	m.setValue(*this);
	return 0 <= m.produce(dst_);
...
bool Source18::save(QDomDocument& dst_) const
{
	Element<Source18, Name::Strict<501> > m;
	m.setValue(*this);
	return 0 <= m.produce(dst_);
...
int Traits<Domain::Xml::Source18>::parse(Domain::Xml::Source18& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Source18>::generate(const Domain::Xml::Source18& src_, QDomElement& dst_)
{
	marshal_type m;
