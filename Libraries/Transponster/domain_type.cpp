...
bool Topology::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Topology, Name::Strict<1016> > m;
	if (0 > m.consume(k))
		return false;
...
bool Feature::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Feature, Name::Strict<1010> > m;
	if (0 > m.consume(k))
		return false;
...
bool Cell::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Cell, Name::Strict<1021> > m;
	if (0 > m.consume(k))
		return false;
...
bool Entry::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Entry, Name::Strict<1027> > m;
	if (0 > m.consume(k))
		return false;
...
bool Entry1::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Entry1, Name::Strict<1027> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Osxen269>::parse(Domain::Xml::Osxen269& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Osxen269>::generate(const Domain::Xml::Osxen269& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getBootloader(), m.get<0>()))
		return -1;
...
int Traits<Domain::Xml::Osxen270>::parse(Domain::Xml::Osxen270& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Osxen270>::generate(const Domain::Xml::Osxen270& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getBootloader(), m.get<0>()))
		return -1;
...
int Traits<Domain::Xml::Clock395>::parse(Domain::Xml::Clock395& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Clock395>::generate(const Domain::Xml::Clock395& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Clock401>::parse(Domain::Xml::Clock401& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Clock401>::generate(const Domain::Xml::Clock401& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getAdjustment(), m.get<1>()))
		return -1;
...
int Traits<Domain::Xml::Timer410>::parse(Domain::Xml::Timer410& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Timer410>::generate(const Domain::Xml::Timer410& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getName(), m.get<0>()))
		return -1;
...
int Traits<Domain::Xml::Timer417>::parse(Domain::Xml::Timer417& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Timer417>::generate(const Domain::Xml::Timer417& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Timer420>::parse(Domain::Xml::Timer420& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Timer420>::generate(const Domain::Xml::Timer420& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getName(), m.get<0>()))
		return -1;
...
int Traits<Domain::Xml::Memory1162>::parse(Domain::Xml::Memory1162& , QStack<QDomElement>& stack_)
{
	marshal_type m;
	return m.consume(stack_);
}

int Traits<Domain::Xml::Memory1162>::generate(const Domain::Xml::Memory1162& , QDomElement& dst_)
{
	marshal_type m;
	return m.produce(dst_);
}
...
bool Apic::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Apic, Name::Strict<982> > m;
	if (0 > m.consume(k))
		return false;
...
bool Spinlocks::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Spinlocks, Name::Strict<1102> > m;
	if (0 > m.consume(k))
		return false;
...
bool VendorId::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<VendorId, Name::Strict<1008> > m;
	if (0 > m.consume(k))
		return false;
...
bool Pvspinlock::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Pvspinlock, Name::Strict<988> > m;
	if (0 > m.consume(k))
		return false;
...
bool Capabilities::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Capabilities, Name::Strict<919> > m;
	if (0 > m.consume(k))
		return false;
...
bool Vmport::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Vmport, Name::Strict<991> > m;
	if (0 > m.consume(k))
		return false;
...
bool SuspendToMem::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<SuspendToMem, Name::Strict<805> > m;
	if (0 > m.consume(k))
		return false;
...
bool SuspendToDisk::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<SuspendToDisk, Name::Strict<807> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Disk478>::parse(Domain::Xml::Disk478& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Disk478>::generate(const Domain::Xml::Disk478& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Seclabel242>::parse(Domain::Xml::Seclabel242& , QStack<QDomElement>& stack_)
{
	marshal_type m;
	return m.consume(stack_);
}

int Traits<Domain::Xml::Seclabel242>::generate(const Domain::Xml::Seclabel242& , QDomElement& dst_)
{
	marshal_type m;
	return m.produce(dst_);
}
...
int Traits<Domain::Xml::Seclabel244>::parse(Domain::Xml::Seclabel244& , QStack<QDomElement>& stack_)
{
	marshal_type m;
	return m.consume(stack_);
}

int Traits<Domain::Xml::Seclabel244>::generate(const Domain::Xml::Seclabel244& , QDomElement& dst_)
{
	marshal_type m;
	return m.produce(dst_);
}
...
int Traits<Domain::Xml::Host517>::parse(Domain::Xml::Host517& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Host517>::generate(const Domain::Xml::Host517& src_, QDomElement& dst_)
{
	marshal_type m;
...
bool Source2::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source2, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
bool Source3::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source3, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
bool Source4::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source4, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
namespace Xml
{
bool Anonymous1163::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	k.push(src_.firstChildElement());
	return 0 <= Traits<Anonymous1163>::parse(*this, k);
}

bool Anonymous1163::save(QDomElement& dst_) const
{
	return 0 <= Traits<Anonymous1163>::generate(*this, dst_);
}
...
int Traits<Domain::Xml::Anonymous1163>::parse(Domain::Xml::Anonymous1163& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Anonymous1163>::generate(const Domain::Xml::Anonymous1163& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Mirror1078>::parse(Domain::Xml::Mirror1078& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
	{
		...
		dst_.setAnonymous1163(m.get<3>().getValue());
	}
	return output;
}

int Traits<Domain::Xml::Mirror1078>::generate(const Domain::Xml::Mirror1078& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getFile(), m.get<0>()))
		return -1;
	...
	if (0 > Details::Marshal::assign(src_.getJob(), m.get<2>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getAnonymous1163(), m.get<3>()))
		return -1;
...
int Traits<Domain::Xml::Mirror1080>::parse(Domain::Xml::Mirror1080& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Mirror1080>::generate(const Domain::Xml::Mirror1080& src_, QDomElement& dst_)
{
	marshal_type m;
...
bool Mirror::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Mirror, Name::Strict<1076> > m;
	if (0 > m.consume(k))
		return false;
...
bool Auth::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Auth, Name::Strict<1085> > m;
	if (0 > m.consume(k))
		return false;
...
bool Secret1::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Secret1, Name::Strict<149> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Variant1093>::parse(Domain::Xml::Variant1093& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Variant1093>::generate(const Domain::Xml::Variant1093& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Variant1097>::parse(Domain::Xml::Variant1097& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Variant1097>::generate(const Domain::Xml::Variant1097& src_, QDomElement& dst_)
{
	marshal_type m;
...
bool Iotune::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Iotune, Name::Strict<1091> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Iotune>::parse(Domain::Xml::Iotune& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		dst_.setChoice1094(m.get<0>().getValue());
		dst_.setChoice1098(m.get<1>().getValue());
	}
	return output;
}
...
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getChoice1094(), m.get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice1098(), m.get<1>()))
		return -1;
...
namespace Xml
{
bool Anonymous1164::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	k.push(src_.firstChildElement());
	return 0 <= Traits<Anonymous1164>::parse(*this, k);
}

bool Anonymous1164::save(QDomElement& dst_) const
{
	return 0 <= Traits<Anonymous1164>::generate(*this, dst_);
}
...
int Traits<Domain::Xml::Anonymous1164>::parse(Domain::Xml::Anonymous1164& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Anonymous1164>::generate(const Domain::Xml::Anonymous1164& src_, QDomElement& dst_)
{
	marshal_type m;
...
bool Blockio::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Blockio, Name::Strict<542> > m;
	if (0 > m.consume(k))
		return false;
...
bool BackingStore::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<BackingStore, Name::Strict<486> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Variant611>::parse(Domain::Xml::Variant611& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Variant611>::generate(const Domain::Xml::Variant611& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getModel(), m.get<0>()))
		return -1;
...
int Traits<Domain::Xml::Variant619>::parse(Domain::Xml::Variant619& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
	{
		dst_.setModel(m.get<1>().getValue());
		dst_.setTarget(m.get<2>().getValue());
		dst_.setChoice618(m.get<3>().getValue());
	}
	return output;
}

int Traits<Domain::Xml::Variant619>::generate(const Domain::Xml::Variant619& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getModel(), m.get<1>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getTarget(), m.get<2>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice618(), m.get<3>()))
		return -1;
...
int Traits<Domain::Xml::Variant623>::parse(Domain::Xml::Variant623& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Variant623>::generate(const Domain::Xml::Variant623& src_, QDomElement& dst_)
{
	marshal_type m;
...
bool Driver1::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Driver1, Name::Strict<545> > m;
	if (0 > m.consume(k))
		return false;
...
bool Controller::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Controller, Name::Strict<571> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Controller>::parse(Domain::Xml::Controller& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setChoice624(m.get<1>().get<2>().getValue());
...
int Traits<Domain::Xml::Controller>::generate(const Domain::Xml::Controller& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getAddress(), m.get<1>().get<1>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice624(), m.get<1>().get<2>()))
		return -1;
...
bool Lease::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Lease, Name::Strict<464> > m;
	if (0 > m.consume(k))
		return false;
...
bool Driver2::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Driver2, Name::Strict<545> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Filesystem630>::parse(Domain::Xml::Filesystem630& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Filesystem630>::generate(const Domain::Xml::Filesystem630& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Filesystem631>::parse(Domain::Xml::Filesystem631& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Filesystem631>::generate(const Domain::Xml::Filesystem631& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getDriver(), m.get<1>()))
		return -1;
...
int Traits<Domain::Xml::Filesystem633>::parse(Domain::Xml::Filesystem633& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Filesystem633>::generate(const Domain::Xml::Filesystem633& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getDriver(), m.get<1>()))
		return -1;
...
int Traits<Domain::Xml::Filesystem635>::parse(Domain::Xml::Filesystem635& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Filesystem635>::generate(const Domain::Xml::Filesystem635& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getDriver(), m.get<1>()))
		return -1;
...
int Traits<Domain::Xml::Filesystem636>::parse(Domain::Xml::Filesystem636& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Filesystem636>::generate(const Domain::Xml::Filesystem636& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getDriver(), m.get<1>()))
		return -1;
...
bool Source5::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source5, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Filesystem640>::parse(Domain::Xml::Filesystem640& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Filesystem640>::generate(const Domain::Xml::Filesystem640& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getDriver(), m.get<1>()))
		return -1;
...
bool Filesystem::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Filesystem, Name::Strict<629> > m;
	if (0 > m.consume(k))
		return false;
...
bool Source6::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source6, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
bool Backend::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Backend, Name::Strict<692> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Driver697>::parse(Domain::Xml::Driver697& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Driver697>::generate(const Domain::Xml::Driver697& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getName(), m.get<0>()))
		return -1;
...
bool Host::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Host, Name::Strict<512> > m;
	if (0 > m.consume(k))
		return false;
...
bool Driver3::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Driver3, Name::Strict<545> > m;
	if (0 > m.consume(k))
		return false;
...
bool Parameter::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Parameter, Name::Strict<1072> > m;
	if (0 > m.consume(k))
		return false;
...
bool FilterrefNodeAttributes::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<FilterrefNodeAttributes, Name::Strict<705> > m;
	if (0 > m.consume(k))
		return false;
...
bool Tune::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Tune, Name::Strict<707> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Interface657>::parse(Domain::Xml::Interface657& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Interface657>::generate(const Domain::Xml::Interface657& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Interface659>::parse(Domain::Xml::Interface659& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Interface659>::generate(const Domain::Xml::Interface659& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getSource(), m.get<1>().get<0>()))
		return -1;
...
bool Source7::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source7, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Interface663>::parse(Domain::Xml::Interface663& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Interface663>::generate(const Domain::Xml::Interface663& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getSource(), m.get<1>().get<0>()))
		return -1;
...
bool Source8::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source8, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
bool Source9::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source9, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Interface666>::parse(Domain::Xml::Interface666& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Interface666>::generate(const Domain::Xml::Interface666& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getSource(), m.get<1>().get<0>()))
		return -1;
...
int Traits<Domain::Xml::Interface669>::parse(Domain::Xml::Interface669& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Interface669>::generate(const Domain::Xml::Interface669& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getSource(), m.get<1>().get<0>()))
		return -1;
...
bool Source10::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source10, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
namespace Xml
{
Interface672::Interface672(): m_type()
{
}
...
int Traits<Domain::Xml::Interface672>::parse(Domain::Xml::Interface672& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Interface672>::generate(const Domain::Xml::Interface672& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getType(), m.get<0>()))
		return -1;
...
bool Source11::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source11, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Interface673>::parse(Domain::Xml::Interface673& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Interface673>::generate(const Domain::Xml::Interface673& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getSource(), m.get<1>().get<0>()))
		return -1;
...
int Traits<Domain::Xml::Source679>::parse(Domain::Xml::Source679& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Source679>::generate(const Domain::Xml::Source679& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Address683>::parse(Domain::Xml::Address683& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Address683>::generate(const Domain::Xml::Address683& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getBus(), m.get<1>()))
		return -1;
...
bool Source12::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source12, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Interface685>::parse(Domain::Xml::Interface685& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Interface685>::generate(const Domain::Xml::Interface685& src_, QDomElement& dst_)
{
	marshal_type m;
...
bool Input::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Input, Name::Strict<900> > m;
	if (0 > m.consume(k))
		return false;
...
bool Sound::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Sound, Name::Strict<865> > m;
	if (0 > m.consume(k))
		return false;
...
bool Source13::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source13, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Source925>::parse(Domain::Xml::Source925& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Source925>::generate(const Domain::Xml::Source925& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getUsbproduct(), m.get<0>()))
		return -1;
...
bool Source14::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source14, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Source928>::parse(Domain::Xml::Source928& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Source928>::generate(const Domain::Xml::Source928& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getProtocol(), m.get<0>()))
		return -1;
...
bool Host1::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Host1, Name::Strict<512> > m;
	if (0 > m.consume(k))
		return false;
...
namespace Xml
{
Source929::Source929(): m_protocol()
{
}
...
int Traits<Domain::Xml::Source929>::parse(Domain::Xml::Source929& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Source929>::generate(const Domain::Xml::Source929& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getProtocol(), m.get<0>()))
		return -1;
...
int Traits<Domain::Xml::Hostdev>::parse(Domain::Xml::Hostdev& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		dst_.setChoice910(m.get<0>().getValue());
...
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getChoice910(), m.get<0>()))
		return -1;
...
int Traits<Domain::Xml::Variant724>::parse(Domain::Xml::Variant724& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Variant724>::generate(const Domain::Xml::Variant724& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Listen776>::parse(Domain::Xml::Listen776& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Listen776>::generate(const Domain::Xml::Listen776& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Graphics733>::parse(Domain::Xml::Graphics733& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		dst_.setChoice726(m.get<1>().getValue());
...
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getChoice726(), m.get<1>()))
		return -1;
...
bool Channel::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Channel, Name::Strict<743> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Graphics768>::parse(Domain::Xml::Graphics768& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Graphics768>::generate(const Domain::Xml::Graphics768& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getPort(), m.get<1>()))
		return -1;
...
int Traits<Domain::Xml::Graphics772>::parse(Domain::Xml::Graphics772& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Graphics772>::generate(const Domain::Xml::Graphics772& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getPort(), m.get<1>()))
		return -1;
...
int Traits<Domain::Xml::Graphics774>::parse(Domain::Xml::Graphics774& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Graphics774>::generate(const Domain::Xml::Graphics774& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getDisplay(), m.get<1>()))
		return -1;
...
bool Acceleration::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Acceleration, Name::Strict<787> > m;
	if (0 > m.consume(k))
		return false;
...
bool Source15::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source15, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Target3>::parse(Domain::Xml::Target3& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		dst_.setChoice820(m.get<0>().getValue());
		dst_.setPort(m.get<1>().getValue());
	}
	return output;
}
...
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getChoice820(), m.get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getPort(), m.get<1>()))
		return -1;
...
bool Channel1::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Channel1, Name::Strict<743> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Channel1>::parse(Domain::Xml::Channel1& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setChoice887(m.get<1>().get<1>().getValue());
...
int Traits<Domain::Xml::Channel1>::generate(const Domain::Xml::Channel1& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getQemucdevSrcDef(), m.get<1>().get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice887(), m.get<1>().get<1>()))
		return -1;
...
int Traits<Domain::Xml::Smartcard888>::parse(Domain::Xml::Smartcard888& , QStack<QDomElement>& stack_)
{
	marshal_type m;
	return m.consume(stack_);
}

int Traits<Domain::Xml::Smartcard888>::generate(const Domain::Xml::Smartcard888& , QDomElement& dst_)
{
	marshal_type m;
	return m.produce(dst_);
}
...
int Traits<Domain::Xml::Smartcard892>::parse(Domain::Xml::Smartcard892& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Smartcard892>::generate(const Domain::Xml::Smartcard892& src_, QDomElement& dst_)
{
	marshal_type m;
...
namespace Xml
{
Smartcard893::Smartcard893(): m_type()
{
}
...
int Traits<Domain::Xml::Smartcard893>::parse(Domain::Xml::Smartcard893& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Smartcard893>::generate(const Domain::Xml::Smartcard893& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getType(), m.get<1>()))
		return -1;
...
bool Smartcard::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Smartcard, Name::Strict<749> > m;
	if (0 > m.consume(k))
		return false;
...
bool Redirdev::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Redirdev, Name::Strict<905> > m;
	if (0 > m.consume(k))
		return false;
...
bool Usbdev::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Usbdev, Name::Strict<833> > m;
	if (0 > m.consume(k))
		return false;
...
namespace Xml
{
Backend1067::Backend1067(): m_type()
{
}
...
int Traits<Domain::Xml::Backend1067>::parse(Domain::Xml::Backend1067& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Backend1067>::generate(const Domain::Xml::Backend1067& src_, QDomElement& dst_)
{
	marshal_type m;
	if (0 > Details::Marshal::assign(src_.getType(), m.get<1>()))
		return -1;
...
bool Rate::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Rate, Name::Strict<1069> > m;
	if (0 > m.consume(k))
		return false;
...
bool Source16::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Source16, Name::Strict<500> > m;
	if (0 > m.consume(k))
		return false;
...
bool Watchdog::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Watchdog, Name::Strict<873> > m;
	if (0 > m.consume(k))
		return false;
...
bool Memballoon::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Memballoon, Name::Strict<879> > m;
	if (0 > m.consume(k))
		return false;
...
bool Panic::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Panic, Name::Strict<980> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Devices>::parse(Domain::Xml::Devices& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setChoice978List(m.get<1>().getValue());
...
int Traits<Domain::Xml::Devices>::generate(const Domain::Xml::Devices& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getEmulator(), m.get<0>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getChoice978List(), m.get<1>()))
		return -1;
...
int Traits<Domain::Xml::Seclabel236>::parse(Domain::Xml::Seclabel236& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Seclabel236>::generate(const Domain::Xml::Seclabel236& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Seclabel238>::parse(Domain::Xml::Seclabel238& dst_, QStack<QDomElement>& stack_)
{
	marshal_type m;
	int output = m.consume(stack_);
	if (0 <= output)
...
int Traits<Domain::Xml::Seclabel238>::generate(const Domain::Xml::Seclabel238& src_, QDomElement& dst_)
{
	marshal_type m;
...
int Traits<Domain::Xml::Seclabel240>::parse(Domain::Xml::Seclabel240& , QStack<QDomElement>& stack_)
{
	marshal_type m;
	return m.consume(stack_);
}

int Traits<Domain::Xml::Seclabel240>::generate(const Domain::Xml::Seclabel240& , QDomElement& dst_)
{
	marshal_type m;
	return m.produce(dst_);
}
...
bool Env::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Env, Name::Strict<1149> > m;
	if (0 > m.consume(k))
		return false;
...
bool Commandline::load(const QDomElement& src_)
{
	QStack<QDomElement> k;
	k.push(src_);
	Element<Commandline, Name::Scoped<1147, 1150> > m;
	if (0 > m.consume(k))
		return false;
...
int Traits<Domain::Xml::Domain>::parse(Domain::Xml::Domain& dst_, QStack<QDomElement>& stack_)
{
	...
	if (0 <= output)
	{
		...
		dst_.setMetadata(m.get<2>().get<2>().getValue());
		dst_.setCpu(m.get<2>().get<3>().getValue());
		dst_.setSysinfo(m.get<2>().get<4>().getValue());
		dst_.setOs(m.get<2>().get<5>().getValue());
		dst_.setClock(m.get<2>().get<6>().getValue());
		dst_.setMemory(m.get<2>().get<7>().getValue());
		dst_.setMaxMemory(m.get<2>().get<8>().getValue());
		dst_.setCurrentMemory(m.get<2>().get<9>().getValue());
		dst_.setMemoryBacking(m.get<2>().get<10>().getValue());
		dst_.setVcpu(m.get<2>().get<11>().getValue());
		dst_.setVcpus(m.get<2>().get<12>().getValue());
		dst_.setIothreads(m.get<2>().get<13>().getValue());
		dst_.setBlkiotune(m.get<2>().get<14>().getValue());
		dst_.setMemtune(m.get<2>().get<15>().getValue());
		dst_.setCputune(m.get<2>().get<16>().getValue());
		dst_.setNumatune(m.get<2>().get<17>().getValue());
		dst_.setResource(m.get<2>().get<18>().getValue());
		dst_.setFeatures(m.get<2>().get<19>().getValue());
		dst_.setOnReboot(m.get<2>().get<20>().getValue());
...
int Traits<Domain::Xml::Domain>::generate(const Domain::Xml::Domain& src_, QDomElement& dst_)
{
	...
	if (0 > Details::Marshal::assign(src_.getDescription(), m.get<2>().get<1>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getMetadata(), m.get<2>().get<2>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getCpu(), m.get<2>().get<3>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getSysinfo(), m.get<2>().get<4>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getOs(), m.get<2>().get<5>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getClock(), m.get<2>().get<6>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getMemory(), m.get<2>().get<7>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getMaxMemory(), m.get<2>().get<8>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getCurrentMemory(), m.get<2>().get<9>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getMemoryBacking(), m.get<2>().get<10>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getVcpu(), m.get<2>().get<11>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getVcpus(), m.get<2>().get<12>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getIothreads(), m.get<2>().get<13>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getBlkiotune(), m.get<2>().get<14>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getMemtune(), m.get<2>().get<15>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getCputune(), m.get<2>().get<16>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getNumatune(), m.get<2>().get<17>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getResource(), m.get<2>().get<18>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getFeatures(), m.get<2>().get<19>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getOnReboot(), m.get<2>().get<20>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getOnPoweroff(), m.get<2>().get<21>()))
		return -1;
	if (0 > Details::Marshal::assign(src_.getOnCrash(), m.get<2>().get<22>()))
		return -1;
