...
struct Iotune: boost::static_visitor<void>
{
	...
	void operator()(const T& ) const
	{
		...
		void operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice1101::types, 0>::type& iopsLimit_) const;
		void operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice1097::types, 0>::type& ioLimit_) const;
