...
struct Iotune: boost::static_visitor<void>
{
	...
	void operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice1053::types, 0>::type& iopsLimit_) const;
	void operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice1049::types, 0>::type& ioLimit_) const;
...
struct Device: boost::static_visitor<PRL_RESULT>
{
	...
	PRL_RESULT operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice934::types, 0>::type& disk_) const;
	PRL_RESULT operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice934::types, 1>::type& controller_) const;
	PRL_RESULT operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice934::types, 4>::type& interface_) const;
	PRL_RESULT operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice934::types, 6>::type& sound_) const;
	PRL_RESULT operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice934::types, 8>::type& graphics_) const
	{
		return boost::apply_visitor(Graphics(*m_vm), graphics_.getValue()); 
	}
	PRL_RESULT operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice934::types, 9>::type& video_) const;
	PRL_RESULT operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice934::types, 11>::type& parallel_) const;
	PRL_RESULT operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice934::types, 12>::type& serial_) const;
...
struct Addressing: boost::static_visitor<void>
{
	...
	void operator()(const mpl::at_c<Libvirt::Iface::Xml::VChoice1274::types, 0>::type& ) const
	{
		m_sink->setConfigureWithDhcp(true);
	}
	void operator()(const mpl::at_c<Libvirt::Iface::Xml::VChoice1274::types, 1>::type& ) const
	{
		m_sink->setConfigureWithDhcp(false);
	}

private:
	void consume(const boost::optional<Libvirt::Iface::Xml::VChoice1274 >& ipv4_) const
	{
		if (ipv4_)
...
struct Collect: boost::static_visitor<void>
{
	...
	void operator()(const mpl::at_c<Libvirt::Domain::Xml::VChoice934::types, 1>::type& controller_) const
	{
...
struct Mask: boost::static_visitor<void>
{
	...
	void operator()(const mpl::at_c<Libvirt::Network::Xml::VChoice1174::types, 0>::type& addr_) const
	{
		m_result->setIPNetMask(QHostAddress(addr_.getValue()));
	}
	void operator()(const mpl::at_c<Libvirt::Network::Xml::VChoice1174::types, 1>::type& prefix_) const
	{
...
struct Master: boost::static_visitor<bool>
{
	...
	bool operator()(const mpl::at_c<Libvirt::Iface::Xml::VChoice1238::types, 0>::type& ethernet_) const
	{
	...
	bool operator()(const mpl::at_c<Libvirt::Iface::Xml::VChoice1238::types, 1>::type& vlan_) const
	{
