...
bool Traits<Iface::Xml::PData1202>::parse(const QString& src_, Iface::Xml::PData1202::value_type& dst_)
{
	bool output = false;
...
QString Traits<Iface::Xml::PData1202>::generate(Iface::Xml::PData1202::value_type src_)
{
	return QString::number(src_);
}

bool Validatable<Iface::Xml::PData1202>::validate(Iface::Xml::PData1202::value_type value_)
{
	if (0 > value_)
		return false;
...
bool Validatable<Iface::Xml::PData1204>::validate(const Iface::Xml::PData1204::value_type& value_)
{
...
bool Traits<Iface::Xml::PData1206>::parse(const QString& src_, Iface::Xml::PData1206::value_type& dst_)
{
	bool output = false;
	dst_ = src_.toInt(&output);
	return output;
...
QString Traits<Iface::Xml::PData1206>::generate(Iface::Xml::PData1206::value_type src_)
{
	return QString::number(src_);
}

bool Validatable<Iface::Xml::PData1206>::validate(Iface::Xml::PData1206::value_type value_)
{
	if (0 > value_)
		return false;
...
bool Validatable<Iface::Xml::PData1208>::validate(const Iface::Xml::PData1208::value_type& value_)
{
