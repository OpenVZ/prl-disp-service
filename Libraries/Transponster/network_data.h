...
namespace Xml
{
typedef Choice<mpl::vector<PData1142, PData1144 > > VUUIDImpl;
...
namespace Xml
{
typedef Choice<mpl::vector<PData1134, PData1136 > > VUint8rangeImpl;
...
namespace Xml
{
typedef Choice<mpl::vector<PData1138, PData1140 > > VUint24rangeImpl;
