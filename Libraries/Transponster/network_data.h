...
template<>
struct Traits<Network::Xml::PData1124>
{
	static bool parse(const QString& src_, Network::Xml::PData1124::value_type& dst_);

	static QString generate(Network::Xml::PData1124::value_type src_);
...
{
	static bool validate(Network::Xml::PData1124::value_type value_);
...
{
	static bool validate(const Network::Xml::PData1130::value_type& value_);
...
namespace Xml
{
typedef Choice<mpl::vector<PData1130, PData1132 > > VUUIDImpl;
...
namespace Xml
{
typedef Choice<mpl::vector<PData1122, PData1124 > > VUint8rangeImpl;
...
namespace Xml
{
typedef Choice<mpl::vector<PData1126, PData1128 > > VUint24rangeImpl;
