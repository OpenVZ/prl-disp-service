...
namespace Xml
{
typedef Choice<mpl::vector<Host3838, Ordered<mpl::vector<Attribute<mpl::int_<520>, Name::Strict<514> >, Attribute<Snapshot::Xml::PAbsFilePath, Name::Strict<521> > > > > > VHostImpl;
...
namespace Xml
{
typedef Choice<mpl::vector<Variant4016, Variant4017, Ordered<mpl::vector<Attribute<mpl::int_<445>, Name::Strict<105> >, Element<Snapshot::Xml::Source2, Name::Strict<501> > > > > > VChoice4019Impl;
...
///////////////////////////////////////////////////////////////////////////////
// struct Host3838 traits

template<>
struct Traits<Snapshot::Xml::Host3838>
{
	...
	static int parse(Snapshot::Xml::Host3838& , QStack<QDomElement>& );
	static int generate(const Snapshot::Xml::Host3838& , QDomElement& );
};
