...
bool Resources::getClock(Libvirt::Domain::Xml::Clock& dst_)
{
	...
	Libvirt::Domain::Xml::Clock6991 k;
...
void Resources::setMemGuarantee(const boost::optional<Libvirt::Domain::Xml::Memtune>& src_)
{
	CVmHardware* h = getHardware();
	if (NULL == h)
		return;

	if (!src_ || !src_.get().getMinGuarantee())
	{
		h->getMemory()->setMemGuaranteeType(PRL_MEMGUARANTEE_PERCENTS);
		h->getMemory()->setMemGuarantee(0);
		return;
	}
...
bool Resources::getChipset(Libvirt::Domain::Xml::Os2& dst_)
{
	...
	mpl::at_c<Libvirt::Domain::Xml::VChoice5117::types, 0>::type t;
	t.setValue(m);
	dst_.setType(Libvirt::Domain::Xml::VChoice5117(t));
...
void Hdd::setBackingChain()
{
	...
	foreach (CVmHddPartition* x, m_hdd.m_lstPartition)
	{
		...
		Libvirt::Domain::Xml::Format format;
...
boost::optional<Libvirt::Domain::Xml::Bandwidth1 > View::getBandwidth() const
{
	...
	Libvirt::Domain::Xml::Bandwidth1 b;
	if (i)
	{
	...
	(const CVmGenericNetworkAdapter& network_, const boot_type& boot_)
{
	...
	if (boot_.is_initialized())
	{
		Libvirt::Domain::Xml::Boot b;
		b.setOrder(boot_.get());
		i.setBoot(b);
	}
...
template<>
Libvirt::Domain::Xml::Interface7022 Adapter<0>::prepare(const CVmGenericNetworkAdapter& network_)
{
	Libvirt::Domain::Xml::Interface7022 output;
	...
	Libvirt::Domain::Xml::Target3 target;
	target.setDev(network_.getHostInterfaceName());
...
template<>
Libvirt::Domain::Xml::Interface7023 Adapter<1>::prepare(const CVmGenericNetworkAdapter& network_)
{
	Libvirt::Domain::Xml::Interface7023 output;
...
template<>
Libvirt::Domain::Xml::Interface7025 Adapter<3>::prepare(const CVmGenericNetworkAdapter& network_)
{
...
{
	mpl::at_c<Libvirt::Domain::Xml::VChoice7097::types, 1>::type output;
	output.setValue(object_);
	return Libvirt::Domain::Xml::VChoice7097(output);
}

///////////////////////////////////////////////////////////////////////////////
// class Moldy

Moldy::result_type Moldy::operator()(Libvirt::Domain::Xml::EType9 bus_, quint16 index_)
{
	mpl::at_c<Libvirt::Domain::Xml::VChoice5126::types, 0>::type b;
	b.setValue(bus_);
...
//	d.setIothread(1);
	mpl::at_c<Libvirt::Domain::Xml::VChoice5126::types, 1>::type b;
...
Libvirt::Domain::Xml::VAddress Attachment::craftIde(quint32 index_)
{
	...
	if (c > 0 && u == 0 && b == 0)
		m_controllers << m_moldy(Libvirt::Domain::Xml::EType9Ide, c);
...
Libvirt::Domain::Xml::VAddress Attachment::craftSata(quint32 index_)
{
	...
	if (c > 0 && u == 0)
		m_controllers << m_moldy(Libvirt::Domain::Xml::EType9Sata, c);
...
void List::addGuestChannel(const QString &path_)
{
	...
	mpl::at_c<Libvirt::Domain::Xml::VChoice9400::types, 1>::type x;

	Libvirt::Domain::Xml::Target6 t;
	t.setName(path_);
...
{
	Libvirt::Domain::Xml::Interface iface;
	iface.setInterface(adapter_);
	add<INTERFACE>(iface);
}
...
void List::add(const CVmGenericPciDevice* pci_)
{
	...
	mpl::at_c<Libvirt::Domain::Xml::VChoice7065::types, 0>::type h;
	h.setValue(g);
...
{
	Libvirt::Domain::Xml::Variant5124 v;
	v.setModel(model_);
	mpl::at_c<Libvirt::Domain::Xml::VChoice5126::types, 2>::type x;
	x.setValue(v);
...
void List::add(Libvirt::Domain::Xml::EType13 type_)
{
...
{
	add(Libvirt::Domain::Xml::EType13Keyboard);
}
...
void List::addMouse()
{
	...
	if (m_controller)
		add(Libvirt::Domain::Xml::EType13Tablet);
	else
		add(Libvirt::Domain::Xml::EType13Mouse);
}
...
{
	const Libvirt::Domain::Xml::Source7072& u = variant_.getValue();
...
PRL_RESULT Cpu::setNode()
{
	...
	d.setMode(Libvirt::Domain::Xml::EMode8Strict);
	...
	Device<CVmSerialPort>::getLibvirtXml(const CVmSerialPort& model_)
{
	...
	case PVE::SerialTCP:
		...
		a.setMode(getMode(model_.getSocketMode()));
		{
			...
			r.setType(Libvirt::Domain::Xml::EType16Raw);
			b.setProtocol(r);
		}
		l << a;
		break;
	...
	Device<CVmGenericNetworkAdapter>::getPlugXml(const CVmGenericNetworkAdapter& model_)
{
	...
	mpl::at_c<Extract<Libvirt::Domain::Xml::VChoice7097Impl>::type,
	Transponster::Device::List::XML_DEVICES_ORDER::INTERFACE >::type e;

	Libvirt::Domain::Xml::Interface iface;
	iface.setInterface(a.value());
	e.setValue(iface);
...
RemoteDisplayUpdater::vnc_type RemoteDisplayUpdater::prepareVncXML(const CVmRemoteDisplay* vnc_)
{
	...
	Libvirt::Domain::Xml::Variant9522 v;
	...
	mpl::at_c<Libvirt::Domain::Xml::VChoice8004::types, 0>::type y;
	y.setValue(v);
	Libvirt::Domain::Xml::Graphics7039 g;
	g.setChoice8004(Libvirt::Domain::Xml::VChoice8004(y));
	...
	Device<CHwUsbDevice>::getView(const CHwUsbDevice& model_)
{
	...
	Libvirt::Domain::Xml::Source7072 a;
	a.setUsbproduct(p);
	...
	if (m_result->getOs().which() == 1)
	{
		const mpl::at_c<Libvirt::Domain::Xml::VOs::types, 1>::type& o =
			boost::get<mpl::at_c<Libvirt::Domain::Xml::VOs::types, 1>::type>
				(m_result->getOs());
		os.reset(new Libvirt::Domain::Xml::Os2(o.getValue().getOs()));
...
bool Builder::getStartupOptions(Libvirt::Domain::Xml::Os2& os_) const
{
	...
	if (b->isEfiEnabled())
	{
		...
		l.setReadonly(Libvirt::Domain::Xml::EVirYesNoYes);
		l.setType(Libvirt::Domain::Xml::EType4Pflash);
...
PRL_RESULT Builder::setDevices()
{
	...
	x.setChoice7097List(Transponster::Device::deviceList_type()
			<< b.getDeviceList()
			<< t.getAttachment().getControllers()
			<< u.getDevices());

	// Currently we dont have apropriate device in libvirt
	// Here we just add default for for Watchdog fromt libvirt
...
PRL_RESULT Builder::setResources(const VtInfo& vt_)
{
	...
	Libvirt::Domain::Xml::Os2 current_os2 = current_vos.getValue().getOs();
	if (u.getChipset(current_os2)){
		Libvirt::Domain::Xml::Oshvm res_oshvm;
		res_oshvm.setOs(current_os2);
...
PRL_RESULT Mixer::setDevices()
{
	...
	QList<Libvirt::Domain::Xml::VChoice7097 > h;
	boost::optional<Libvirt::Domain::Xml::Devices> d = m_result->getDevices();
	if (d)
	{
		Visitor::Mixer::Device v;
		foreach (const Libvirt::Domain::Xml::VChoice7097& e, d.get().getChoice7097List())
		{
			e.apply_visitor(v);
		}
		h = v.getResult();
	...
	if (PRL_SUCCEEDED(output))
	{
		...
		QList<Libvirt::Domain::Xml::VChoice7097 > t = d.get().getChoice7097List();
		d.get().setChoice7097List(t << h);
...
PRL_RESULT Fixer::setDevices()
{
	...
	QList<Libvirt::Domain::Xml::VChoice7097> l = a.getDeviceList();

	Visitor::Fixup::Device v(m_input.getVmHardwareList(), l);
	foreach (const Libvirt::Domain::Xml::VChoice7097& e, d->getChoice7097List())
	{
		boost::apply_visitor(v, e);
	}

	Libvirt::Domain::Xml::Devices devices = *d;
	devices.setChoice7097List(l);
...
PRL_RESULT Operator::plug(Pipeline::object_type& object_)
{
	...
	mpl::at_c<Libvirt::Domain::Xml::VChoice7097::types, 7>::type j;
	j.setValue(Device<CHwUsbDevice>::getView(*m_model));

	Transponster::Device::deviceList_type k = d->getChoice7097List();
	k.prepend(j);
	d->setChoice7097List(k);
...
PRL_RESULT Operator::unplug(Pipeline::object_type& object_)
{
	...
	Transponster::Device::deviceList_type a = d->getChoice7097List();
...
struct Builder
{
	...
	void setAddress(const QHostAddress& host_, const QHostAddress& mask_)
	{
		...
		mpl::at_c<Libvirt::Network::Xml::VChoice2404::types, 1>::type m;
		m.setValue(p);
		m_result.setChoice2404(Libvirt::Network::Xml::VChoice2404(m));
	}
...
PRL_RESULT Reverse::setMaster()
{
	...
	mpl::at_c<Libvirt::Iface::Xml::VChoice7155::types, 0>::type v;
	v.setValue(e);
	Libvirt::Iface::Xml::Bridge b = m_result.getBridge();
	b.setChoice7155List(QList<Libvirt::Iface::Xml::VChoice7155>() << v);
	m_result.setBridge(b);
	return PRL_ERR_SUCCESS;
}
...
PRL_RESULT Reverse::setBridge()
{
	...
	m_result.setBridge(b);
	Libvirt::Iface::Xml::InterfaceAddressing7159 h;
...
Reverse::Reverse(const CVmGenericNetworkAdapter &adapter) : m_adapter(adapter), m_result(new Libvirt::Filter::Xml::Filter())
{
	...
	QList <Libvirt::Filter::Xml::VChoice9242> contents;
	...
	m_result->setChoice9242List(contents);
}
...
Libvirt::Filter::Xml::VChoice9242
			...
			Libvirt::Filter::Xml::RuleNodeAttributes rule_attributes)
{
	...
	mpl::at_c<Libvirt::Filter::Xml::VChoice9242::types, 1>::type rule_holder;
...
QList<Libvirt::Filter::Xml::VChoice9242>
...
{
	QString proto = basic_rule.getProtocol().toLower();
	...
	QList<Libvirt::Filter::Xml::VChoice9242> rule_holders;
	if (isIPv6 || isBoth)
	{
...
{
	QList <Libvirt::Filter::Xml::VChoice9242> result;
...
QList<Libvirt::Filter::Xml::VChoice9242> Reverse::prepareAllowEstablished(Libvirt::Filter::Xml::EDirectionType direction, int priority) {
	QList<Libvirt::Filter::Xml::VChoice9242> result;
	Libvirt::Filter::Xml::CommonPortAttributes port_attributes;
	Libvirt::Filter::Xml::RuleNodeAttributes rule_attributes;
...
QList<Libvirt::Filter::Xml::VChoice9242> Reverse::prepareDefaultDeny(Libvirt::Filter::Xml::EDirectionType direction, int priority)
{
	QList<Libvirt::Filter::Xml::VChoice9242> result;
	...
	foreach(const uint& nd_message_id, nd_messages_ids)
	{
		...
		result.append(Libvirt::Filter::Xml::VChoice9242(rule_holder));
	}
...
boost::optional<Libvirt::Filter::Xml::VChoice9242>
Reverse::prepareIpSpoofing(const CVmGenericNetworkAdapter &adapter)
{
	...
	mpl::at_c<Libvirt::Filter::Xml::VChoice9242::types, 0>::type filterref_holder;
	filterref_holder.setValue(filterref);
	return Libvirt::Filter::Xml::VChoice9242(filterref_holder);
}
...
Reverse::prepareNetFilters(const CVmGenericNetworkAdapter &adapter)
{
	...
	boost::optional<Libvirt::Filter::Xml::VChoice9242> c;
...
QList<Libvirt::Filter::Xml::Icmp> Reverse::prepareIcmp(
	const Libvirt::Filter::Xml::CommonIpAttributesP1 &ips,
	const boost::optional<unsigned int>& type)
{
	Libvirt::Filter::Xml::Icmp icmp;

	icmp.setCommonIpAttributesP1(ips);

	Libvirt::Filter::Xml::IcmpAttributes icmp_attributes;
	if (type)
		icmp_attributes.setType(prepareIcmpType(type.get()));
	icmp.setIcmpAttributes(icmp_attributes);

	QList <Libvirt::Filter::Xml::Icmp> icmp_list;
	icmp_list.append(icmp);
...
QList<Libvirt::Filter::Xml::Icmpv6> Reverse::prepareIcmpv6(
	const Libvirt::Filter::Xml::CommonIpv6AttributesP1 &ips,
	const boost::optional<unsigned int>& type)
{
	Libvirt::Filter::Xml::Icmpv6 icmpv6;

	icmpv6.setCommonIpv6AttributesP1(ips);
